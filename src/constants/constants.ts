export const developers = [
  ...
  },
  {
    ...
    imgSrc: 'https://avatars.githubusercontent.com/u/91553443?v=4',
    imgAlt: 'Dmiriy',
    contribute: 'Set up project,GraphQL Client page',
  },
  {
    nameOfPerson: 'Maksym',
    ...
    imgAlt: 'Maksym',
    contribute: 'Sign In/Sign up pages,REST Client page',
  },
];
